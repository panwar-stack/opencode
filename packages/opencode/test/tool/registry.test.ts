...
const registryLayer = (flags: Partial<RuntimeFlags.Info> = {}, config?: Config.Info) =>
  ToolRegistry.layer
    .pipe(
...
const teams = testEffect(
  Layer.mergeAll(registryLayer({}, { experimental: { agent_teams: true } }), node, Agent.defaultLayer),
)
