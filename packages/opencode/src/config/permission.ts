...
const InputObject = Schema.StructWithRest(
  Schema.Struct({
    ...
    workflow_submit_plan_pull_request: Schema.optional(Rule),
    workflow_sync_github: Schema.optional(Rule),
    workflow_address_plan_review: Schema.optional(Rule),
    workflow_execute: Schema.optional(Rule),
    workflow_submit_code_pull_request: Schema.optional(Rule),
    workflow_address_code_review: Schema.optional(Rule),
    workflow_amend: Schema.optional(Rule),
    workflow_steer: Schema.optional(Rule),
    workflow_commit: Schema.optional(Rule),
    workflow_branch: Schema.optional(Rule),
  }),
