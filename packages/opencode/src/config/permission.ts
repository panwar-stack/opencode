...
const InputObject = Schema.StructWithRest(
  Schema.Struct({
    ...
    memory_search_commit: Schema.optional(Action),
    memory_examine_commit: Schema.optional(Action),
    memory_search_summary: Schema.optional(Action),
    memory_view_summary: Schema.optional(Action),
