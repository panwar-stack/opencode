export const dict = {
  ...
  "notification.pair.peerJoined.title": "Pair connected",
  "notification.pair.peerJoined.description": "A peer joined {{sessionTitle}} in {{projectName}}",
  "notification.pair.controlRequested.title": "Pair control requested",
  "notification.pair.controlRequested.description": "A peer requested control in {{sessionTitle}} in {{projectName}}",
  ...
  "session.pair.start": "Pair",
  "session.pair.active": "Pair {{count}}",
  "session.pair.copyInvite": "Copy pair invite",
  "session.pair.toast.started.title": "Pair room started",
  "session.pair.toast.started.description": "Copy an invite to add a peer.",
  "session.pair.toast.inviteCopied.title": "Pair invite copied",
  "session.pair.toast.inviteCopied.description": "Send the invite link to your peer.",
  "session.pair.toast.joined.title": "Joined pair room",
  "session.pair.toast.joined.description": "You can follow the session in real time.",
  "session.pair.peerName.web": "Web peer",
  "session.pair.control.requested.title": "Control requested",
  "session.pair.control.requested.description": "Peer {{peer}} wants to drive this session.",
  "session.pair.control.grant": "Grant",
  "session.pair.control.locked.title": "Peer is driving",
  "session.pair.control.locked.description": "The composer is locked while another peer has control.",
  "session.pair.control.request": "Request control",
  "session.pair.control.release": "Release control",
