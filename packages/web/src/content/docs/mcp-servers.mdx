...
OpenCode includes a default local `browser_use` MCP server for browser automation. It runs through the Python Browser Use package.
...
To override the default command and request headed browser mode explicitly:
