...
For coordinated multi-agent work, [Agent Teams](/docs/agent-teams) let a lead session spawn and manage multiple teammate sessions with dependencies, mailbox messages, shared tasks, and optional plan approval.
...
| `webfetch`              | `webfetch`                                                       |
| `websearch`             | `websearch`                                                      |
| `memory_search_commit`  | `memory_search_commit`                                           |
| `memory_examine_commit` | `memory_examine_commit`                                          |
| `memory_search_summary` | `memory_search_summary`                                          |
| `memory_view_summary`   | `memory_view_summary`                                            |
| `lsp`                   | `lsp`                                                            |
| `skill`                 | `skill`                                                          |
| `question`              | `question`                                                       |
...
:::note
Repository memory tools require repository memory to be enabled and an existing index for the active repository. Memory results are historical hints; agents should verify against current source before editing.
:::
