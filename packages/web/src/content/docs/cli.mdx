...
Manage historical review memory.
...
Index GitHub PR review comments into local memory.
...
| Flag                                    | Description                                                        |
| --------------------------------------- | ------------------------------------------------------------------ |
| <nobr><code>{"--repo"}</code></nobr>  | GitHub repository in `owner/repo` form                             |
| <nobr><code>{"--since"}</code></nobr> | Only fetch comments updated after this date                        |
| <nobr><code>{"--limit"}</code></nobr> | Maximum number of comments to fetch                                |
| <nobr><code>{"--reset"}</code></nobr> | Clear indexed GitHub memory for this repository without fetching   |

---

#### query

Query indexed memory by task text.
...
| Flag                                   | Description                  |
| -------------------------------------- | ---------------------------- |
| <nobr><code>{"--file"}</code></nobr> | Limit results to a file path |
| <nobr><code>{"--json"}</code></nobr> | Print results as JSON        |

---

#### review

Show review memories relevant to the current diff or a GitHub PR.

```bash
opencode memory review [--base ref] [--pr number] [--json]
```
...
| Flag                                   | Description                                            |
| -------------------------------------- | ------------------------------------------------------ |
| <nobr><code>{"--base"}</code></nobr> | Base branch or ref to compare against (defaults `dev`) |
| <nobr><code>{"--pr"}</code></nobr>   | GitHub pull request number to review                   |
| <nobr><code>{"--json"}</code></nobr> | Print results as JSON                                  |
