...
Clarify underspecified requests before planning or implementation.
...
Draft an implementation-ready Markdown spec from rough requirements, feature ideas, bug themes, or implementation goals.
