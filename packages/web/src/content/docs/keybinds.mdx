...
```json title="tui.json"
{
  ...
  "keybinds": {
    ...
    "session_parent": "up",
    "team_panel_toggle": "<leader>v",
    "team_cycle_lead": "<leader>up",
    "team_task_list": "<leader>k",
...
For [Agent Teams](/docs/agent-teams), the defaults are `team_panel_toggle` = `\<leader>v`, `team_task_list` = `\<leader>k`, and `team_cycle_lead` = `\<leader>up`.
