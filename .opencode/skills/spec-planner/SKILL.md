...
2. Inspect the repository when paths, modules, APIs, tests, or existing patterns matter. Cite real files in the spec.
...
6. If the user asked to save the spec, write it to the requested path. Otherwise, return the spec body.
